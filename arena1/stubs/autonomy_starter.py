...
def main():
    ...
    loc_service = LocalizationService(host='172.16.18.20', port=5576)  # if passthrough sim, use sim's ip address.
    rep_service = ReportingService(host='172.16.18.20', port=5511)
    ...
    controller = PIDController(Kp=(0.5, 0.2), Ki=(0.2, 0.1), Kd=(0.0, 0.0))  # this can be tuned.

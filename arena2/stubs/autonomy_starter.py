...
def main():
    ...
    loc_service = LocalizationService(host='172.16.118.20', port=5577)  # if passthrough sim, use sim's ip address.
    rep_service = ReportingService(host='172.16.118.20', port=5512)
